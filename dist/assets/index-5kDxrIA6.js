...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:pn,depthTest:!1,depthWrite:!1})}function Ya(){return new Kt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Zo(),fragmentShader:`
		...
		`,blending:pn,depthTest:!1,depthWrite:!1})}function ja(){return new Kt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Zo(),fragmentShader:`
...
`].filter(Xi).join(`
`)),o=Po(o),o=rl(o,t),o=ol(o,t),a=Po(a),a=rl(a,t),a=ol(a,t),o=al(o),a=al(a),t.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
#endif
`,Ys=new rn;Ys.setAttribute("position",new Ht(new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),3));Ys.setAttribute("uv",new Ht(new Float32Array([0,0,2,0,0,2]),2));Ys.boundingSphere=new ei(new D,1e8);const Qo=new Qn;Qo.matrixAutoUpdate=!1;const Zm=new qo,js=new Se(Ys,null);js.frustumCulled=!1;js.matrixAutoUpdate=!1;Qo.add(js);function sc(s,e,t,n=!1,i=0){js.material=e,s.setRenderTarget(t,i),n&&s.clear(!0,!1,!1),s.render(Qo,Zm)}class ct{constructor(e,t,n,i={}){this.name=e,this.uniforms=n,this.material=new Kt({name:e,uniforms:n,vertexShader:$m,fragmentShader:t,depthTest:!1,depthWrite:!1,blending:i.blending??pn,defines:i.defines??{},glslVersion:i.glslVersion??null,transparent:i.blending!==void 0&&i.blending!==pn})}render(e,t,n=!1){sc(e,this.material,t,n)}dispose(){this.material.dispose()}}function Ze(s,e,t={}){const n=new jt(Math.max(1,s),Math.max(1,e),{type:Gt,format:pt,minFilter:lt,magFilter:lt,wrapS:It,wrapT:It,depthBuffer:!1,stencilBuffer:!1,generateMipmaps:!1,...t});return n.texture.name=t.name??"hdr",n.texture.colorSpace=Nn,n}const pl=new D,Cs=new D,Jm=new D(0,1,0),Qm=new D(0,0,1),Pr=new Te,ml=new Ne,Dr=new ei,Lr=new D;class e0{constructor(e,t){this.renderer=e,this.cascades=Math.max(1,Math.min(4,t.cascades|0)),this.mapSize=Math.min(t.mapSize??2048,2048),this.maxDistance=t.maxDistance??140,this.lambda=.86,this.backDistance=140,this.enabled=!0,this.rt=new Eh(this.mapSize,this.mapSize,this.cascades,{type:Ft,format:is,minFilter:ft,magFilter:ft,wrapS:It,wrapT:It,depthBuffer:!0,stencilBuffer:!1,generateMipmaps:!1}),this.rt.texture.name="csm",this.cameras=[],this.matrices=[];for(let n=0;n<this.cascades;n++){const i=new Ko(-1,1,1,-1,.01,1e3);i.matrixAutoUpdate=!1,this.cameras.push(i),this.matrices.push(new Ne)}this.uniforms={owCsmMaps:{value:this.rt.texture},owCsmMatrix:{value:this.matrices},owCsmSplit:{value:new Te(1e9,1e9,1e9,1e9)},owCsmSplitNear:{value:new Te(0,0,0,0)},owCsmTexel:{value:new Te(.01,.01,.01,.01)},owCsmRange:{value:new Te(1,1,1,1)},owCsmMapSize:{value:new ue(this.mapSize,1/this.mapSize)},owSunDirView:{value:new D(0,1,0)},owSunDirWorld:{value:new D(0,1,0)},owCsmParams:{value:new Te(1,.022,9,0)}},this.depthMaterial=new Kt({name:"csm-depth",side:dn,vertexShader:`
        #include <common>
        #include <batching_pars_vertex>
        #include <skinning_pars_vertex>
        #include <morphtarget_pars_vertex>
...
`,s0=.7;class r0{constructor(){this.rt=null,this.width=1,this.height=1,this.prev=new Map,this._seen=new Set,this.material=new Kt({name:"ow-prepass",glslVersion:To,side:An,uniforms:{owPrevModelMatrix:{value:new Ne},owCurrVP:{value:new Ne},owPrevVP:{value:new Ne},owMatId:{value:0},owCoverage:{value:1}},vertexShader:`
        #include <common>
        #include <batching_pars_vertex>
        #include <skinning_pars_vertex>
        #include <morphtarget_pars_vertex>
