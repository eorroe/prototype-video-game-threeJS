...
`;class u0{constructor(){this.pass=new ct("ow-contact",c0,{tDepth:{value:null},tNormal:{value:null},uProj:{value:new Fe},uProjInv:{value:new Fe},uSunDirView:{value:new P(0,1,0)},uParams:{value:new Ee(.4,.42,0,1)}}),this.blur=new ct("ow-contact-blur",h0,{tSrc:{value:null},uDirection:{value:new he}}),this.rtA=null,this.rtB=null,this.texture=null}setLength(e){this.pass.uniforms.uParams.value.x=e}setStrength(e){this.pass.uniforms.uParams.value.w=e}setSize(e,t){this.rtA?.dispose(),this.rtB?.dispose();const n={type:kt,format:Ti,name:"contact"};this.rtA=Je(e,t,n),this.rtB=Je(e,t,n),this._texel=new he(1/e,1/t)}render(e,t,n,i,r){const o=this.pass.uniforms;o.tDepth.value=t.depthTexture,o.tNormal.value=t.normalTexture,o.uProj.value.copy(n.projectionMatrix),o.uProjInv.value.copy(n.projectionMatrixInverse),o.uSunDirView.value.copy(i),o.uParams.value.z=r%64,this.pass.render(e,this.rtA);const a=this.blur.uniforms;return a.tSrc.value=this.rtA.texture,a.uDirection.value.set(this._texel.x,0),this.blur.render(e,this.rtB),a.tSrc.value=this.rtB.texture,a.uDirection.value.set(0,this._texel.y),this.blur.render(e,this.rtA),this.texture=this.rtA.texture,this.texture}dispose(){this.rtA?.dispose(),this.rtB?.dispose(),this.pass.dispose(),this.blur.dispose()}}const d0=`
precision highp float;
${Tt}
