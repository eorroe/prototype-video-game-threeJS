...
async function main() {
  console.log('[xvfb] Starting with Xvfb...');
  ...
  try {
    ...
    console.log('[xvfb] Taking screenshot...');
    await page.screenshot({ path: `${OUT_DIR}/xvfb.png`, type: 'png', timeout: 30000 });
    console.log('[xvfb] Screenshot saved');
