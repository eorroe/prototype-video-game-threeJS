...
async function main() {
  ...
  try {
    ...
    console.log('[xvfb2] Taking screenshot...');
    await page.screenshot({ path: `${OUT_DIR}/xvfb2.png`, type: 'png', timeout: 30000 });
    console.log('[xvfb2] Screenshot saved');
    
  } catch (e) {
    console.log(`[xvfb2] Error: ${e.message}`);
  } finally {
    await browser.close();
  }
}
