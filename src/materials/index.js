...
const SURFACES = {
  concrete: { albedo: [0.65, 0.63, 0.60], roughness: 0.92, metal: 0 },
  metal_painted: { albedo: [0.55, 0.58, 0.62], roughness: 0.65, metal: 0.85 },
  metal_rust: { albedo: [0.65, 0.42, 0.27], roughness: 0.82, metal: 0.8 },
  metal_brushed: { albedo: [0.65, 0.64, 0.62], roughness: 0.5, metal: 0.9 },
  brick: { albedo: [0.65, 0.50, 0.36], roughness: 0.93, metal: 0 },
  wood: { albedo: [0.50, 0.33, 0.18], roughness: 0.88, metal: 0 },
  asphalt: { albedo: [0.22, 0.22, 0.22], roughness: 0.96, metal: 0 },
  gravel: { albedo: [0.55, 0.53, 0.50], roughness: 0.93, metal: 0 },
  dirt: { albedo: [0.45, 0.35, 0.22], roughness: 0.96, metal: 0 },
  plaster: { albedo: [0.70, 0.68, 0.65], roughness: 0.9, metal: 0 },
  fabric: { albedo: [0.32, 0.27, 0.22], roughness: 0.96, metal: 0 },
  corrugated: { albedo: [0.45, 0.45, 0.48], roughness: 0.78, metal: 0.85 },
  rubber: { albedo: [0.15, 0.15, 0.15], roughness: 0.93, metal: 0 },
  foliage: { albedo: [0.22, 0.37, 0.13], roughness: 0.92, metal: 0 },
  burlap: { albedo: [0.50, 0.41, 0.27], roughness: 0.96, metal: 0 },
  black_ops: { albedo: [0.18, 0.18, 0.22], roughness: 0.6, metal: 0.1 },
  flesh: { albedo: [0.28, 0.18, 0.16], roughness: 0.7, metal: 0 },
  infected: { albedo: [0.22, 0.27, 0.16], roughness: 0.85, metal: 0 },
};
