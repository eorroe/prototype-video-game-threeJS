...
const SURFACES = {
  concrete: { albedo: [0.45, 0.44, 0.42], roughness: 0.92, metal: 0 },
  metal_painted: { albedo: [0.38, 0.4, 0.44], roughness: 0.65, metal: 0.85 },
  metal_rust: { albedo: [0.5, 0.32, 0.2], roughness: 0.82, metal: 0.8 },
  metal_brushed: { albedo: [0.5, 0.49, 0.48], roughness: 0.5, metal: 0.9 },
  brick: { albedo: [0.5, 0.38, 0.28], roughness: 0.93, metal: 0 },
  wood: { albedo: [0.38, 0.25, 0.14], roughness: 0.88, metal: 0 },
  asphalt: { albedo: [0.15, 0.15, 0.15], roughness: 0.96, metal: 0 },
  gravel: { albedo: [0.38, 0.36, 0.34], roughness: 0.93, metal: 0 },
  dirt: { albedo: [0.3, 0.24, 0.16], roughness: 0.96, metal: 0 },
  plaster: { albedo: [0.6, 0.58, 0.56], roughness: 0.9, metal: 0 },
  fabric: { albedo: [0.24, 0.2, 0.17], roughness: 0.96, metal: 0 },
  corrugated: { albedo: [0.32, 0.32, 0.34], roughness: 0.78, metal: 0.85 },
  rubber: { albedo: [0.1, 0.1, 0.1], roughness: 0.93, metal: 0 },
  foliage: { albedo: [0.14, 0.24, 0.08], roughness: 0.92, metal: 0 },
  burlap: { albedo: [0.35, 0.28, 0.18], roughness: 0.96, metal: 0 },
  black_ops: { albedo: [0.08, 0.08, 0.1], roughness: 0.6, metal: 0.1 },
