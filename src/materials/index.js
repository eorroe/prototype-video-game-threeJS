...
const SURFACES = {
  concrete: { albedo: [0.22, 0.21, 0.20], roughness: 0.92, metal: 0 },
  metal_painted: { albedo: [0.22, 0.24, 0.26], roughness: 0.65, metal: 0.85 },
  metal_rust: { albedo: [0.30, 0.19, 0.12], roughness: 0.82, metal: 0.8 },
  metal_brushed: { albedo: [0.30, 0.29, 0.28], roughness: 0.5, metal: 0.9 },
  brick: { albedo: [0.30, 0.22, 0.16], roughness: 0.93, metal: 0 },
  wood: { albedo: [0.22, 0.15, 0.08], roughness: 0.88, metal: 0 },
  asphalt: { albedo: [0.10, 0.10, 0.10], roughness: 0.96, metal: 0 },
  gravel: { albedo: [0.22, 0.21, 0.20], roughness: 0.93, metal: 0 },
  dirt: { albedo: [0.18, 0.14, 0.09], roughness: 0.96, metal: 0 },
  plaster: { albedo: [0.32, 0.30, 0.29], roughness: 0.9, metal: 0 },
  fabric: { albedo: [0.15, 0.12, 0.10], roughness: 0.96, metal: 0 },
  corrugated: { albedo: [0.18, 0.18, 0.20], roughness: 0.78, metal: 0.85 },
  rubber: { albedo: [0.06, 0.06, 0.06], roughness: 0.93, metal: 0 },
  foliage: { albedo: [0.08, 0.13, 0.05], roughness: 0.92, metal: 0 },
  burlap: { albedo: [0.20, 0.16, 0.11], roughness: 0.96, metal: 0 },
  black_ops: { albedo: [0.06, 0.06, 0.07], roughness: 0.6, metal: 0.1 },
  flesh: { albedo: [0.13, 0.08, 0.07], roughness: 0.7, metal: 0 },
  infected: { albedo: [0.10, 0.12, 0.07], roughness: 0.85, metal: 0 },
};
