...
- After each module is implemented, a dedicated Reviewer agent performs a blind visual comparison between the module output and reference screenshots from the game reference images captured from the same camera angle and lighting condition.
